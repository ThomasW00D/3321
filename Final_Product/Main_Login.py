...
class LoadingPage(QWidget):
    ...
    def init_ui(self):
        ...
        button1.clicked.connect(lambda: self.option1_clicked(self))
    ...
    def option1_clicked(self, window):
        self.openGmail(window)
...
if __name__ == "__main__":
    ...
    splash = Welcome_Page.SplashScreen()
    splash.show()
